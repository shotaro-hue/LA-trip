...
const DAYS = [
{
id:"0820", label:"8/20 水", theme:"#60a5fa", icon:"✈️", title:"到着日",
schedule:[
...
{
id:"0821", label:"8/21 木", theme:"#34d399", icon:"🎨", title:"DTLA〜ハリウッド観光",
schedule:[
...
const DANGER_ZONES = [
{ c:[[34.0518,-118.2502],[34.0518,-118.2335],[34.0408,-118.2335],[34.0408,-118.2502]], t:"⛔ Skid Row｜全米最大ホームレス密集地\n暴力犯罪・薬物蔓延。絶対立入禁止" },
